// projectList.js
module.exports = [
  {id: 1, title: "AI-Powered Chatbot", description: "Build an intelligent chatbot using AI technologies."},
  {id: 2, title: "E-Commerce Website", description: "Create a platform for online shopping."},
